...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  #s.source_files = 'JWBSign/**/*'
  
  s.subspec 'SignHome' do |signHome|
      signHome.source_files = 'JWBSign/SignHome/**/*'
      signHome.public_header_files = 'JWBSign/SignHome/**/*.h'
  end

  s.resources = ['JWBSign/Assets/**/*.*']
